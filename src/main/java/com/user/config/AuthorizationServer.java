...
import com.user.service.oauth.impl.MyClientDetialService;
import com.user.service.oauth.impl.MyUserDetialService;
...
class AuthorizationServer extends AuthorizationServerConfigurerAdapter {
    ...
    @Resource
    private MyUserDetialService  userDetailsService;
    @Resource
